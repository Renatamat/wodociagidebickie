...
class TimelineExpressBase {
	...
	public function __construct() {
		...
		/* Register our custom timeline express image size (350px x 120px)  fix 280x200*/
		add_image_size( 'timeline-express', '280', '200', true );

		/* Regiser our custom timeline express thumbnail image size (200px x 120px) - Used in the admin table */
		add_image_size( 'timeline-express-thumbnail', '280', '200', true );
